...
const privacySections = [
  ...
  { title: "6. Terminbuchung (Calendly)", text: "Auf unserer Kontaktseite ist ein Inline-Widget des Dienstes Calendly (Calendly Inc., USA) eingebunden. Beim Aufruf der Kontaktseite wird das Widget geladen und es können Daten wie IP-Adresse, Browserinformationen sowie bei einer Buchung Name, E-Mail-Adresse und die gewählte Terminzeit an Calendly übermittelt und dort verarbeitet werden. Dabei kann es zu einer Datenübermittlung in die USA kommen, welche auf Basis geeigneter Garantien (z. B. Standardvertragsklauseln) erfolgt. Weitere Informationen finden Sie in der Datenschutzerklärung von Calendly." },
  { title: "7. Cookies", text: "Diese Website setzt derzeit keine optionalen Analyse- oder Marketing-Cookies ein. Technisch notwendige Cookies können verwendet werden, soweit sie für den Betrieb erforderlich sind." },
  { title: "8. Google-Dienste", text: "Google Search Console wird zur technischen Überwachung der Auffindbarkeit in Suchmaschinen verwendet. Der Dienst erhebt auf dieser Website keine personenbezogenen Nutzungsprofile. Sollte Google Analytics oder ein vergleichbarer Analysedienst künftig eingesetzt werden, wird diese Erklärung vorab ergänzt und eine gegebenenfalls erforderliche Einwilligung eingeholt." },
